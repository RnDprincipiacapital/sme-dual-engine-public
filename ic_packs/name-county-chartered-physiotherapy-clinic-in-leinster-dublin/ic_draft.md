...
- `summary` from businessesforsale_ie (observed, confidence 1.0): Well established clinic with large client base located in an area with quickly growing population. Established referrals from all local GP practises. BusinessesForSale.ie JSON-LD listing observed 2026-06-24.
