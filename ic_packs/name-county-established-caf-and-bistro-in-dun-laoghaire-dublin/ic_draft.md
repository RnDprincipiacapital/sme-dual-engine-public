...
- `evidence_text` from businessesforsale_ie (observed, confidence 1.0): public advertised-for-sale listing EUR 155000 BusinessesForSale.ie JSON-LD listing observed 2026-06-24.
...
- `summary` from businessesforsale_ie (observed, confidence 1.0): Trading for 4 years with a strong customer base. This is a great opportunity for expansion. Fully fitted at high standards can be operated as a coffee shop as well as a restaurant as there are no... BusinessesForSale.ie JSON-LD listing observed 2026-06-24.
